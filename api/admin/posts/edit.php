    ...
    <div class="admin-content">
      ...
      <div class="content">
        ...
        <form action="edit.php" method="post" enctype="multipart/form-data">
          ...
          <div>
            <label>Body</label>
            <textarea name="body" id="body"><?php echo html_entity_decode($post['body']); ?></textarea>
          </div>
          <div>
            <label>Image</label>
            <input type="file" name="image">

            <!-- Keep old image in case user doesn’t upload a new one -->
            <input type="hidden" name="old_image" value="<?php echo $post['image']; ?>">

            <?php if (!empty($post['image'])): ?>
              <p>Current Image:</p>
              <img src="<?php echo BASE_URL . '/assets/images/' . $post['image']; ?>" alt="Post image" width="150">
            <?php endif; ?>
